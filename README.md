...
2. [Описание проекта](#ii)
3. [Шаги для запуска](#iii)
4. [Система публикаций](#iv)
5. [Безопасность](#v)
6. [Системные ограничения](#vi)
7. [API Endpoints](#vii)
8. [Обработка ошибок](#viii)
9. [Особенности реализации](#ix)
10. [Интерфейс](#x)
...
2. Настройка БД:
    ```bash
    createdb my_blog
    psql -d my_blog -f migrations/init.sql
    ```
3. Сборка и запуск:
    ```bash
    make zip
...
<h2 id="vi" >Системные ограничения</h2>
...
<h2 id="viii" >Обработка ошибок</h2>
...
<h2 id="ix" >Особенности реализации</h2>
